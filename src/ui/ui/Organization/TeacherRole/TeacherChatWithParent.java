 ...
 * @author bbpri
 */
public class TeacherChatWithParent extends javax.swing.JPanel {

    private JSplitPane splitPane;
    private UserAccount sender;
    private Organization organization;
    private EcoSystem system;
    TeacherChatWorkRequest teacherChatWorkRequest;

    /**
     * Creates new form TeacherChatWithParent
     */
    public TeacherChatWithParent(JSplitPane splitPane, UserAccount account, Organization organization, EcoSystem system) {
    ...
    private void btnback1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnback1ActionPerformed
        ...
        TeacherWorkAreaJPanel nwajp = new TeacherWorkAreaJPanel(splitPane, sender, system, system);
    ...
    private void btnSendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendActionPerformed
        ...
        int selectedRow = tblWorkRequest.getSelectedRow();
        if (selectedRow >= 0) {
            teacherChatWorkRequest = (TeacherChatWorkRequest) tblWorkRequest.getValueAt(selectedRow, 0);
        } else {
        ...
        teacherChatWorkRequest.setResultMessage(txtResolution.getText());
        teacherChatWorkRequest.setStatus("Resolved");
        populateTable();
